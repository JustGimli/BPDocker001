    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issued_place', models.CharField(blank=True, max_length=64)),
                ('issued_date', models.DateField(blank=True)),
                ('division_code', models.CharField(blank=True, max_length=32)),
                ('scan_current', models.FileField(blank=True, null=True, upload_to='')),
                ('scan_self', models.FileField(blank=True, null=True, upload_to='')),
                ('adress', models.CharField(blank=True, max_length=128)),
                ('bank_acc', models.CharField(blank=True, max_length=32)),
                ('bank_name', models.CharField(blank=True, max_length=128)),
                ('bank_inn', models.CharField(blank=True, max_length=32)),
                ('bank_bic', models.CharField(blank=True, max_length=64)),
                ('cor_acc', models.CharField(blank=True, max_length=128)),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
